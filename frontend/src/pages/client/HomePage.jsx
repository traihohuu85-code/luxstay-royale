    ...
    <div className="overflow-hidden">
      <section className="relative min-h-[780px] overflow-hidden">
        ...
        <div className="container-lux relative grid min-h-[780px] items-center gap-12 py-16 lg:grid-cols-[1.05fr_0.95fr]">
          <div>
            <div className="mb-6 inline-flex items-center gap-3 rounded-full border border-amber-300/25 bg-amber-300/10 px-4 py-2 text-sm font-black text-amber-100 backdrop-blur-xl"><Crown size={18} fill="currentColor" />Luxury edition Designed by Halleyy</div>
            <h1 className="font-display text-[52px] font-semibold leading-[0.9] tracking-[-0.035em] text-white md:text-[88px]">Trải nghiệm đỉnh cao của sự sang trọng và tiện nghi tại LuxStay Royale</h1>
            <p className="mt-6 max-w-xl text-lg text-slate-400">Khám phá bộ sưu tập phòng cao cấp, dịch vụ đẳng cấp và trải nghiệm khách sạn sang trọng bậc nhất tại LuxStay Royale.</p>
