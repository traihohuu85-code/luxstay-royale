          ...
          <div className="relative">
            <form onSubmit={submit} className="glass-panel p-5 md:p-8">
              ...
              <div className="grid gap-4">
                ...
                <div className="grid gap-4 sm:grid-cols-2"><label className="date-lux mt-2"><CalendarDays className="mr-2 inline text-amber-200" size={16} />Ngày đến<input className="client-input mt-2" type="date" value={form.checkInDate} onChange={(e) => setForm({ ...form, checkInDate: e.target.value })} /></label><label className="date-lux mt-2">Ngày đi<input className="client-input mt-2" type="date" value={form.checkOutDate} onChange={(e) => setForm({ ...form, checkOutDate: e.target.value })} /></label></div>
