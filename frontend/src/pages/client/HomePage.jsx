          ...
          <div className="relative">
            <form onSubmit={submit} className="glass-panel p-5 md:p-8">
              ...
              <div className="grid gap-4">
                ...
                <div className="grid gap-4 sm:grid-cols-2"><label className="label-lux"><span className="flex items-center gap-2"><CalendarDays className="text-amber-200" size={16} />Ngày đến</span><div className="date-field mt-2"><input className="date-native" type="date" value={form.checkIn} onChange={(e) => setForm({ ...form, checkIn: e.target.value })} /><CalendarDays className="date-field-icon" size={18} /></div></label><label className="label-lux"><span className="flex items-center gap-2"><CalendarDays className="text-amber-200" size={16} />Ngày đi</span><div className="date-field mt-2"><input className="date-native" type="date" value={form.checkOut} onChange={(e) => setForm({ ...form, checkOut: e.target.value })} /><CalendarDays className="date-field-icon" size={18} /></div></label></div>
